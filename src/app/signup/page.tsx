        ...
        <form action={signup}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="fullName" className="text-xs font-semibold uppercase tracking-wider">Full Name</Label>
            ...
            <div className="space-y-2">
              ...
              <Input id="password" name="password" type="password" required minLength={6} className="h-11 rounded-xl" />
            </div>
          </CardContent>
